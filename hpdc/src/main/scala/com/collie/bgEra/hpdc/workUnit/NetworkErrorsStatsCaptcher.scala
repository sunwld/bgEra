...
class NetworkErrorsStatsCaptcher extends WorkUnitRunable {
  ...
  override def runWork(workUnitInfo: WorkUnitInfo): Unit = {
    ...
    /**
      * OSTYPE:LINUX
      * Ip:
      * 374576437 total packets received
      * 0 forwarded
      * 0 incoming packets discarded
      * 369186203 incoming packets delivered
      * 366468644 requests sent out
      ...
      * OutType8: 557
      * Tcp:
      * 246595 active connections openings
      * 170273 passive connection openings
      * 81105 failed connection attempts
      * 176364 connection resets received
      * 130 connections established
      * 369184713 segments received
      * 374032768 segments send out
      * 11341 segments retransmited
      ...
      * UdpLite:
      * TcpExt:
      * 470 invalid SYN cookies received
      * 8 resets received for embryonic SYN_RECV sockets
      * 1956 TCP sockets finished time wait in fast timer
      * 3003805 delayed acks sent
      * 24 delayed acks further delayed because of locked socket
      * Quick ack mode was activated 4285 times
      * 31965226 packets directly queued to recvmsg prequeue.
      * 402432 bytes directly in process context from backlog
      * 148688995 bytes directly received in process context from prequeue
      * 302348413 packet headers predicted
      * 249044 packets header predicted and directly queued to user
      * 6081007 acknowledgments not containing data payload received
      * 283498927 predicted acknowledgments
      ...
      * OutMcastPkts: 36
      * InBcastPkts: 2556
      * InOctets: 89406767468
      * OutOctets: 59564118144
      * InMcastOctets: 106284
      * OutMcastOctets: 5746
      * InBcastOctets: 838368
      * InNoECTPkts: 393717539
      */
